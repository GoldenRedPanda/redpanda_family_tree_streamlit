...
def generate_mermaid(family_data, root_name=None, parent_depth=2, child_depth=2):
...
if data:
    mermaid_code = generate_mermaid(data, root_name if root_name else None, parent_depth, child_depth)
