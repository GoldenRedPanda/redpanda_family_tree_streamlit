...
tr, ppy, gantt, genetic, birthday, birth_death_stats, survival_timeline, longevity_ranking = st.tabs(["Family Tree", "Population Pyramid", "Gantt Chart", "Genetic Distribution", "Birthday Calendar", "Birth/Death Stats", "Survival Timeline", "Longevity Ranking"])
with tr:
